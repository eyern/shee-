...
ALLOWED_HOSTS = ['127.0.0.1', 'sheegiftshop.com', 'https://sheegiftshop.com/','shee-production.up.railway.app','https://shee-production.up.railway.app']

CSRF_TRUSTED_ORIGINS = ['https://sheegiftshop.com','https://shee-production.up.railway.app']
